...
**Version:** 1.0  
**Class:** Bard  
**Primary Skill:** Songweaving (ID 63)  
...
## 0.1 Implementation Status (Source of Truth: code)

**Current (Implemented):**
- Songweaving songs (Bardic names): Discordant Note, Song of Courage, Lullaby, Inspire Accuracy, Song of Healing, Dirge of Weakness, Song of Illumination, Song of Swiftness, Song of Provocation.
- Global song cooldown: **7s** per caster.
- Crescendo: builds on successful songs; decays out of combat after 3s.
- Crescendo Finales (basic set): Sharp Note, Mesmerise, Cacophony, Fortissimo, Soothing Chorus, Symphony of Destruction.
- Song Mastery progression (XP per song → points → per-song potency/duration bonuses).
- Songbook spellbook (drag/hotkey icons; uses Songweaving spellbook range 1384-1415), Hotbar UI, Finale Gump + `[song <name>]` / `[songbar]` / `[finale <name>]` / `[finales]` / `[songmastery]` commands.

**Planned / Not Implemented Yet:**
- Advanced Finale list (Coda, Harmonize, Dissonant Strike, etc.).
- Song Mastery talent trees beyond potency/duration (specialized effects).
...
### Current Song Mastery Implementation

- **XP Gain:** +1 XP per successful song.
- **Point Gain:** 10 XP → +1 Song Mastery point.
- **Max Level:** 32.
- **Per-song Upgrades:** Potency or Duration (max 5 each).
- **Bonus per level:** +10% to duration or power (per point).
...
|-------------|------------|
| 0 | Cannot play songs |
| 30 | Basic songs (Song of Provocation, Lullaby), 8-tile range |
| 50 | Intermediate songs (Discordant Note, Song of Healing), 10-tile range |
| 70 | Advanced songs (Fortissimo, Dirge of Weakness), 11-tile range |
...
|----------|-------|
| Range | 0-20 |
| Generation | +1 or +2 per successful song (see below) |
| Decay | -1 per tick after 3s out of combat |
| Full Reset | Not implemented (natural decay only) |

### Crescendo Generation by Song (Current)

| Song Type | Crescendo Generated |
|-----------|---------------------|
| Utility (Song of Illumination, Inspire Accuracy) | +1 |
| Control (Lullaby, Song of Provocation) | +2 |
| Debuff (Discordant Note, Dirge of Weakness) | +2 |
| Support (Song of Healing, Song of Courage, Song of Swiftness) | +1 |

### Crescendo Thresholds

| Crescendo | Unlocks |
|-----------|---------|
| 5 | Planned: Minor Finales |
| 10 | Planned: Standard Finales |
| 15 | Planned: Major Finales |
| 20 | Planned: Magnum Opus |

---

## 3.2 Finales (Implemented - Basic Set)

Finales consume Crescendo and share the global song cooldown.

| Finale | Cost | Target | Effect |
|--------|------|--------|--------|
| **Sharp Note** | 5 | Single | 30-50 sonic damage |
| **Mesmerise** | 5 | Single | Paralyze target for ~4s |
| **Cacophony** | 10 | AoE | 100-140 sonic damage (6 tiles) |
| **Fortissimo** | 15 | AoE | 80-120 sonic damage (5 tiles) |
| **Soothing Chorus** | 15 | Party | Heal 50-80 |
| **Symphony of Destruction** | 20 | AoE | 150-200 sonic damage (8 tiles) |
...
| **Mesmerise** | Paralyze target for ~4 seconds |
...
| **Cacophony** | AoE sonic damage in 6 tiles |
...
| **Lullaby** | AoE Lullaby (6 tiles, 5 seconds, no check) |
...
|----------|-------|---------|
| **Control** | Song of Provocation, Lullaby | Manipulate enemy behavior |
| **Debuff** | Discordant Note, Dirge of Weakness | Weaken enemies |
| **Support** | Song of Healing, Song of Courage, Song of Swiftness | Buff and heal allies |
| **Utility** | Song of Illumination, Inspire Accuracy | Non-combat benefits |
...
**Tune Shattering:**
Lullaby can break early when the target takes damage:
```
...
**Stacking:** Discordant Note does not stack. Reapplying refreshes duration.

---

### Song of Dirge of Weakness
...
|-------|------------|----------|
| **Provoker** | Song of Provocation 16, Discordant Note 16 | Dungeon farmer, pet class support |
| **Controller** | Lullaby 16, Song of Provocation 16 | CC specialist, group utility |
| **War Bard** | Discordant Note 16, Song of Courage 16 | Raid DPS support |
| **Healer Bard** | Song of Healing 16, Song of Courage 8, Song of Swiftness 8 | Off-healer, buffer |
...
| Bonus damage from Discordant Note | 100% of bonus damage |
| Healing from Song of Healing | 1 point per HP healed |
...
|------|-----------------|----------------|
| Song of Provocation | +2 sec/level | -3 difficulty/level |
| Lullaby | +2 sec/level (single), +0.1 sec/level (AoE) | -3 difficulty/level |
| Discordant Note | +2 sec/level | -3 difficulty/level, +1% effect/level |
| Dirge of Weakness | +1.5 sec/level | -3 difficulty/level, +2 damage/level |
| Song of Healing | +1 tick/level | +2 HP per tick/level |
| Song of Courage | +3 sec/level | +1% damage/level |
| Song of Swiftness | +3 sec/level | +1% move, +0.5% attack/level |
...
The **Virtuoso Talent** (see Part VI) adds up to 8 additional effective levels to both Duration and Potency for the three core songs (Song of Provocation, Lullaby, Discordant Note).
...
|---------|-----------|------------|
| Song of Provocation Duration | +2 seconds | +16 seconds |
| Lullaby Duration | +2 seconds | +16 seconds |
| Discordant Note Duration | +2 seconds | +16 seconds |
| Core Song Potency | +3 difficulty reduction | -24 difficulty |
| Discordant Note Effect | +1% | +8% |
...
| Benefit | Per Level | At Max (8) |
|---------|-----------|------------|
| Song of Illumination Duration | +2 minutes | +16 minutes |
| Song of Inspire Accuracy Duration | +2 minutes | +16 minutes |
| Song of Inspire Accuracy Luck | +2 | +16 |
...
| **The Siren's Call** | Ancient Kraken | Song of Provocation works on sea creatures |
| **Thunderhorn** | Griffin Lord | Finales deal +50% damage |
| **The Eternal Chord** | Timeworn Lich | Songs persist 10 seconds after death |
| **Moonsilver Harp** | Lunara's Herald | Song of Healing heals +50%, affects pets |
...
The Bard has a **Songbook** spellbook for drag/hotkey icons, plus a Songweaving gump suite for status, hotbar, and finales. The Finale gump shows a Crescendo tracker and finale buttons.
...
├─────────────────────────────────────────────┤
│  CONTROL SONGS                              │
│  ├─ Song of Provocation    [D:8] [P:8]  ▶ Play      │
│  └─ Lullaby    [D:4] [P:4]  ▶ Play      │
│                                             │
│  DEBUFF SONGS                               │
│  ├─ Discordant Note    [D:6] [P:6]  ▶ Play      │
│  └─ Dirge of Weakness        [D:0] [P:0]  ▶ Play      │
│                                             │
│  SUPPORT SONGS                              │
│  ├─ Song of Healing        [D:2] [P:2]  ▶ Play      │
│  ├─ Song of Courage        [D:0] [P:0]  ▶ Play      │
│  └─ Song of Swiftness      [D:0] [P:0]  ▶ Play      │
│                                             │
│  UTILITY SONGS (Repertoire: 5)              │
│  ├─ Song of Illumination              ▶ Play       │
│  ├─ Song of Inspire Accuracy            ▶ Play       │
│  ├─ Song of Insight            ▶ Play       │
│  └─ Song of Warding            ▶ Play       │
│                                             │
│  FINALES AVAILABLE                          │
│  ├─ [5+]  Coda, Mesmerise, Sharp Note       │
...
│  ACTIVE SONGS               │
│  Orc Captain:               │
│  ├─ Discordant Note [0:42]      │
│  └─ Provoked → Orc Mage     │
│  Orc Mage:                  │
│  └─ Provoked → Orc Captain  │
│  Party:                     │
│  └─ Song of Courage [1:15]          │
└─────────────────────────────┘
```
...
| Devoted (200) | Song of Healing heals +10% |
...
| Power | Tier | Effect |
|-------|------|--------|
| **Tidal Surge** | Devoted | AoE knockback synergizes with Lullaby |
| **Abyssal Call** | Zealot | Summon + Song of Provocation = easy kills |
| **Oceana's Wrath** | Champion | Pairs with Discordant Note for massive damage |
...
| Investment | Levels |
|------------|--------|
| Song of Provocation Duration | 8 |
| Song of Provocation Potency | 8 |
| Discordant Note Duration | 8 |
| Discordant Note Potency | 8 |
| Virtuoso | 8 |
| **Total** | 32 Mastery + 8 Virtuoso |

**Stats:**
- Song of Provocation: 52 second duration, 76%+ success on bosses
- Discordant Note: 52 second duration, 31% effect
...
| Discordant Note Duration | 8 |
| Discordant Note Potency | 8 |
| Song of Courage Duration | 8 |
| Song of Courage Potency | 8 |
| Virtuoso | 8 |
| **Total** | 32 Mastery + 8 Virtuoso |

**Stats:**
- Discordant Note: 52 sec, 31% effect
- Song of Courage: 78 sec, +21% party damage
- Combined: +52% effective damage increase

**Gameplay:** Discord boss, Song of Courage party, spam Battle Hymn finales.
...
**Stats:**
- Lullaby: 52 sec single, 2.6 sec AoE
- Song of Provocation: 52 sec
...
| Investment | Levels |
|------------|--------|
| Song of Healing Duration | 8 |
| Song of Healing Potency | 4 |
| Song of Courage Duration | 4 |
| Song of Courage Potency | 4 |
| Song of Swiftness Duration | 4 |
| Song of Swiftness Potency | 4 |
| Inspire Accuracy via Repertoire | 8 |
| **Total** | 28 Mastery + 8 Repertoire |

**Stats:**
- Song of Healing: 10 ticks, 13 HP/tick (130 total party heal)
- Song of Courage: +9% damage
- Song of Swiftness: +9% move, +5% attack
- Inspire Accuracy: +26 luck
...
|------|-----|-----|----------|---------|--------|
| Song of Provocation | 30 | 7s | 20s | 52s | Creature vs creature |
| Lullaby | 30 | 7s | 20s/1s | 52s/2.6s | Calm target/AoE |
| Discordant Note | 50 | 7s | 20s | 52s | -/+15-31% damage |
| Dirge of Weakness | 70 | 7s | 15s | 27s | Scaling DoT |
| Song of Healing | 50 | 7s | 2 ticks | 10 ticks | AoE HoT |
| Song of Courage | 70 | 7s | 30s | 78s | +5-21% damage |
| Song of Swiftness | 70 | 7s | 30s | 78s | +5-21% move |
| Song of Illumination | 30 | 7s | 10m | 26m | Night sight |
| Inspire Accuracy | 50 | 7s | 10m | 26m | +10-26 luck |
...
| Mesmerise | 5 | Paralyze target ~4s |
