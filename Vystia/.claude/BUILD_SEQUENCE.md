...
```
File Location: C:\DevEnv\GIT\UO\ServUO\Scripts\Commands\VystiaWorldGenerator.cs
```
...
powershell.exe -Command "Copy-Item -Path 'C:\DevEnv\GIT\UO\ServUO\Scripts\bin\Release\Scripts.dll' -Destination 'C:\DevEnv\GIT\UO\ServUO\Scripts.dll' -Force"
```
...
# ❌ DOES NOT WORK:
cmd /c copy "C:\DevEnv\GIT\UO\ServUO\Scripts\bin\Release\Scripts.dll" "C:\DevEnv\GIT\UO\ServUO\Scripts.dll"

# ❌ DOES NOT WORK:
copy /Y C:\DevEnv\GIT\UO\ServUO\Scripts\bin\Release\Scripts.dll C:\DevEnv\GIT\UO\ServUO\Scripts.dll
```
...
```powershell
powershell.exe -Command "Get-Item 'C:\DevEnv\GIT\UO\ServUO\Scripts.dll' | Select-Object Name, LastWriteTime, Length"
...
dotnet build "C:\DevEnv\GIT\UO\ServUO\Scripts\Scripts.csproj" -c Release
...
### **Build Output**
```
C:\DevEnv\GIT\UO\ServUO\Scripts\bin\Release\Scripts.dll
```
...
```powershell
powershell.exe -Command "Copy-Item -Path 'C:\DevEnv\GIT\UO\ServUO\Scripts\Commands\VystiaWorldGenerator.cs' -Destination 'C:\DevEnv\GIT\UO\Vystia\src\VystiaWorldGenerator.cs' -Force"
powershell.exe -Command "Copy-Item -Path 'C:\DevEnv\GIT\UO\ServUO\Scripts\Commands\VystiaMapWiper.cs' -Destination 'C:\DevEnv\GIT\UO\Vystia\src\VystiaMapWiper.cs' -Force"
```

### **Restore from Source Control to ServUO:**
```powershell
powershell.exe -Command "Copy-Item -Path 'C:\DevEnv\GIT\UO\Vystia\src\VystiaWorldGenerator.cs' -Destination 'C:\DevEnv\GIT\UO\ServUO\Scripts\Commands\VystiaWorldGenerator.cs' -Force"
powershell.exe -Command "Copy-Item -Path 'C:\DevEnv\GIT\UO\Vystia\src\VystiaMapWiper.cs' -Destination 'C:\DevEnv\GIT\UO\ServUO\Scripts\Commands\VystiaMapWiper.cs' -Force"
```
