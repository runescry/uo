...
```
Location: D:\UO\ServUO\Server\bin\Release\Scripts\*.cs
...
```
Location: D:\UO\ServUO\Scripts\**\*.cs
...
1. **Edit the runtime file:**
   ```
   D:\UO\ServUO\Server\bin\Release\Scripts\VystiaWorldGenerator.cs
   ```
...
```
Editing: D:\UO\Vystia\src\VystiaWorldGenerator.cs
...
```
Editing: D:\UO\ServUO\Scripts\Custom\VystiaWorldGenerator.cs
...
### ✅ **Correct Approach**
```
Editing: D:\UO\ServUO\Server\bin\Release\Scripts\VystiaWorldGenerator.cs
...
```
D:\UO\ServUO\Server\bin\Release\Scripts\*.cs
```
