...
from britannia_stone_wall_lib import (
...
Examples:
  ...
  python generate_city_walls_cli.py --center-x 1800 --center-y 400 --width 150 --height 150 --wall-type brick --output-dir "C:\\DevEnv\\GIT\\UO\\centredsharp\\output\\editable_maps"
    ...
    if args.circular:
        ...
        # Use advanced Britannia-style walls with battlements (grey stone hue 2500)
        # Britannia walls always use stone structure
        from britannia_stone_wall_lib import WALL_STRUCTURE_STONE
