...
from ice_stone_wall_lib import (
...
Examples:
  ...
  python generate_city_walls_cli.py --center-x 1800 --center-y 400 --width 150 --height 150 --wall-type brick --output-dir "C:\\DevEnv\\GIT\\UO\\centredsharp\\output\\editable_maps"
    ...
    if args.circular:
        ...
        # Use advanced ice/sandstone-style walls with battlements (hue 0x03E9)
        # Ice walls always use sandstone structure
        from ice_stone_wall_lib import WALL_STRUCTURE_SANDSTONE
    ...
    # Remove trees from the wall area (inside and 5 tiles outside)
    print("Removing trees from wall area...")
    existing_blocks = filter_trees_from_area(
        existing_blocks,
        args.center_x,
        args.center_y,
        args.width,
