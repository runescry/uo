						...
						else
						{
							...
							else
							{
								...
								if (targ is BaseCreature)
								{
									...
									// Vystia: Songweaving skill increases Peacemaking duration
									// +0.5% per point (50% at GM)
									if (from.Skills != null)
									{
										double bardicLore = from.Skills[SkillName.Songweaving].Value;
										if (bardicLore > 0)
										{
											seconds *= (1.0 + bardicLore * 0.005); // 0.5% per point
										}
									}
