...
namespace Server.Mobiles
{
	public class XmlSpawner : Item, ISpawner
	{
		...
		// Extended to support custom maps beyond the standard 6 (0-5)
		private static Dictionary<Sector, List<XmlSpawner>>[] GlobalSectorTable = new Dictionary<Sector, List<XmlSpawner>>[32];
