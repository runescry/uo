...
namespace Server.Items
{
    ...
    public abstract class BaseJewel : Item, ICraftable, ISetItem, IWearableDurability, IResource, IVvVItem, IOwnerRestricted, ITalismanProtection, IFactionItem, IArtifact, ICombatEquipment, IQuality, IBlessedItem
    {
        #region Factions
        ...
        public override void Deserialize(GenericReader reader)
        {
                ...
                case 4:
                    {
                        ...
                        // Vystia: Blessed item data (version 12+)
                        if (version >= 12)
                        {
            ...
            // Initialize m_BlessedBy for versions < 4 (it's only read in case 4+)
            if (version < 4)
            {
                m_BlessedBy = null;
            }
