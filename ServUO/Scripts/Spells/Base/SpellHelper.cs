...
namespace Server.Spells
{
    ...
    public class SpellHelper
    {
        ...
        public static int GetSpellDamageBonus(Mobile caster, IDamageable damageable, SkillName skill, bool playerVsPlayer)
        {
            ...
            // Vystia: ArcaneStudies spell power bonus
            if (caster is PlayerMobile pm)
            {
                double arcaneBonus = Server.Custom.VystiaClasses.Systems.VystiaSkillIntegration.GetArcaneStudiesSpellPowerBonus(pm);
                sdiBonus += (int)(arcaneBonus * 100); // Convert to percentage (25% at GM = +25 SDI)
            }
