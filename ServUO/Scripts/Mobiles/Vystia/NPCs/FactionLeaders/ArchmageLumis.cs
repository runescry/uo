...
{
    /// <summary>
    /// Archmage Lumis - Archmage of The Mystic Canyons
    /// Faction: Arcane Coalition
    /// Location: The Mystic Canyons
    /// Personality: Sage, formal, arcane-focused
    /// </summary>
    public class ArchmageLumis : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public ArchmageLumis() : base("Archmage of The Mystic Canyons")
        {
            Name = "Archmage Lumis";
            Title = "Archmage of The Mystic Canyons";
            Body = 0x190;
            Hue = 0x48E; // Purple/magical
        ...
        {
            AddItem(new FancyShirt(0x48E));
            AddItem(new LongPants(0x48E));
            AddItem(new ThighBoots());
            AddItem(new Cloak(0x48E));
        }
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am Archmage Lumis. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public ArchmageLumis(Serial serial) : base(serial)
        {
        }
