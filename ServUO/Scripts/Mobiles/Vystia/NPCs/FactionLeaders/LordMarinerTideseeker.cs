...
{
    /// <summary>
    /// Lord Mariner Tideseeker - Lord Mariner of The Glimmering Archipelago
    /// Faction: Maritime Sovereignty
    /// Location: The Glimmering Archipelago
    /// Personality: Noble maritime leader, diplomatic, ocean-focused
    /// </summary>
    public class LordMarinerTideseeker : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public LordMarinerTideseeker() : base("Lord Mariner of The Glimmering Archipelago")
        {
            Name = "Lord Mariner Tideseeker";
            Title = "Lord Mariner of The Glimmering Archipelago";
            Body = 0x190;
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am Lord Mariner Tideseeker. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public LordMarinerTideseeker(Serial serial) : base(serial)
        {
        }
