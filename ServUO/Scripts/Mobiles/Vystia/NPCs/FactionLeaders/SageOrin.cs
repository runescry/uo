...
{
    /// <summary>
    /// Sage Orin - Sage of The Forgotten Depths
    /// Faction: Arcane Coalition
    /// Location: The Forgotten Depths
    /// Personality: Sage, formal, depth-focused
    /// </summary>
    public class SageOrin : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public SageOrin() : base("Sage of The Forgotten Depths")
        {
            Name = "Sage Orin";
            Title = "Sage of The Forgotten Depths";
            Body = 0x190;
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am Sage Orin. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public SageOrin(Serial serial) : base(serial)
        {
        }
