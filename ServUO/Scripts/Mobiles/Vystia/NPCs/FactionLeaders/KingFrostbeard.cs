...
{
    /// <summary>
    /// King Frostbeard - King of Frosthold
    /// Faction: Polar Alliance
    /// Location: Frosthold
    /// Personality: Chieftain, gruff, ice-focused
    /// </summary>
    public class KingFrostbeard : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public KingFrostbeard() : base("King of Frosthold")
        {
            Name = "King Frostbeard";
            Title = "King of Frosthold";
            Body = 0x190;
            Hue = 0x481; // Ice blue
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am King Frostbeard. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public KingFrostbeard(Serial serial) : base(serial)
        {
        }
