...
{
    /// <summary>
    /// Queen Amaryllis - Queen of Verdantpeak
    /// Faction: Sylvan Concord
    /// Location: Verdantpeak
    /// Personality: Noble, formal, nature-focused
    /// </summary>
    public class QueenAmaryllis : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public QueenAmaryllis() : base("Queen of Verdantpeak")
        {
            Name = "Queen Amaryllis";
            Title = "Queen of Verdantpeak";
            Body = 0x191; // Female
        ...
        {
            AddItem(new FancyShirt(0x7D6));
            AddItem(new LongPants(0x7D6));
            AddItem(new ThighBoots());
            AddItem(new Cloak(0x7D6));
        }
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am Queen Amaryllis. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public QueenAmaryllis(Serial serial) : base(serial)
        {
        }
