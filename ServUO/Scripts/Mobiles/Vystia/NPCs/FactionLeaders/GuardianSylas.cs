...
{
    /// <summary>
    /// Guardian Sylas - Guardian of The Hollow Forests
    /// Faction: Sylvan Concord
    /// Location: The Hollow Forests
    /// Personality: Guardian (Sage), formal, forest-focused
    /// </summary>
    public class GuardianSylas : BaseVendor, ILLMConversational
    {
        ...
        [Constructable]
        public GuardianSylas() : base("Guardian of The Hollow Forests")
        {
            Name = "Guardian Sylas";
            Title = "Guardian of The Hollow Forests";
            Body = 0x190;
            Hue = 0x83F; // Forest green
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from.InRange(this, 3))
            {
                ...
                {
                    Say($"Hail, {from.Name}. I am Guardian Sylas. What brings you before me?");
                    e.Handled = true;
                }
        ...
        public GuardianSylas(Serial serial) : base(serial)
        {
        }
