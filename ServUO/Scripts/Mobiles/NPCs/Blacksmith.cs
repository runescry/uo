...
{
    public class Blacksmith : BaseVendor, IVystiaRepairService
    {
        public bool OffersRepairService { get { return true; } }
        ...
        #region Vystia Repair Service
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            base.GetContextMenuEntries(from, list);

            if (from is PlayerMobile && from.InRange(this.Location, 4))
            {
                list.Add(new VystiaRepairContextMenuEntry(this, from));
            }
        }
        #endregion
