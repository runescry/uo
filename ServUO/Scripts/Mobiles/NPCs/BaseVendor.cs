...
namespace Server.Mobiles
{
	...
	public abstract class BaseVendor : BaseCreature, IVendor, ILLMConversational
	{
		...
		private NPCPersonalities.PersonalityType m_PersonalityType = NPCPersonalities.PersonalityType.Merchant;
		...
		/// <summary>
		/// Infer personality type based on the vendor's class type and title
		/// Checks both the class name and the NPC's title to determine the most appropriate personality
		/// </summary>
		private void InferPersonality()
		{
			string typeName = GetType().Name;
			string title = this.Title != null ? this.Title.ToLower() : "";

			// Try class name first
			if (typeName.Contains("Blacksmith") || title.Contains("blacksmith") || title.Contains("iron worker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Blacksmith;
			else if (typeName.Contains("Weaponsmith") || title.Contains("weaponsmith"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Weaponsmith;
			else if (typeName.Contains("Armorer") || title.Contains("armor"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Armorer;
			else if (typeName.Contains("Mage") || title.Contains("mage") || title.Contains("arcanist") || title.Contains("thaumaturgist") || title.Contains("sorceress") || title.Contains("conjurer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Mage;
			else if (typeName.Contains("Alchemist") || title.Contains("alchemist"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Alchemist;
			else if (typeName.Contains("Healer") || title.Contains("healer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Healer;
			else if (typeName.Contains("Tailor") || title.Contains("tailor"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Tailor;
			else if (typeName.Contains("Tanner") || typeName.Contains("LeatherWorker") || title.Contains("tanner") || title.Contains("leather worker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.LeatherWorker;
			else if (typeName.Contains("Cobbler") || title.Contains("cobbler") || title.Contains("shoemaker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Cobbler;
			else if (typeName.Contains("Tinker") || title.Contains("tinker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Tinker;
			else if (typeName.Contains("Carpenter") || title.Contains("carpenter"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Carpenter;
			else if (typeName.Contains("Bowyer") || title.Contains("bowyer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Bowyer;
			else if (typeName.Contains("Jeweler") || title.Contains("jeweler"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Jeweler;
			else if (typeName.Contains("Scribe") || title.Contains("scribe"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Scribe;
			else if (typeName.Contains("Banker") || title.Contains("banker") || title.Contains("cashier"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Banker;
			else if (typeName.Contains("InnKeeper") || typeName.Contains("Innkeeper") || title.Contains("innkeeper") || title.Contains("tavern keeper"))
				m_PersonalityType = NPCPersonalities.PersonalityType.InnKeeper;
			else if (typeName.Contains("Barkeeper") || title.Contains("barkeeper") || title.Contains("waiter") || title.Contains("waitress") || title.Contains("drinks"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Barkeeper;
			else if (typeName.Contains("Cook") || typeName.Contains("Baker") || title.Contains("cook") || title.Contains("baker") || title.Contains("butcher"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Cook;
			else if (typeName.Contains("Farmer") || typeName.Contains("Rancher") || title.Contains("farmer") || title.Contains("rancher"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Farmer;
			else if (typeName.Contains("Fisherman") || title.Contains("fisher"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Fisherman;
			else if (typeName.Contains("Miner") || title.Contains("miner"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Miner;
			else if (typeName.Contains("Herbalist") || title.Contains("herbalist") || title.Contains("aborist"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Herbalist;
			else if (typeName.Contains("AnimalTrainer") || title.Contains("animal trainer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.AnimalTrainer;
			else if (typeName.Contains("Veterinarian") || title.Contains("vet"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Veterinarian;
			else if (typeName.Contains("Provisioner") || title.Contains("provisioner"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Provisioner;
			else if (typeName.Contains("Artist") || title.Contains("artist") || title.Contains("painter"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Artist;
			else if (typeName.Contains("Bard") || title.Contains("bard") || title.Contains("minstrel"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Bard;
			else if (typeName.Contains("Mapmaker") || title.Contains("mapmaker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Mapmaker;
			else if (typeName.Contains("Shipwright") || title.Contains("shipwright"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Shipwright;
			else if (typeName.Contains("RealEstateBroker") || title.Contains("real estate broker"))
				m_PersonalityType = NPCPersonalities.PersonalityType.RealEstateBroker;
			else if (typeName.Contains("HairStylist") || typeName.Contains("Hairstylist") || title.Contains("hairstylist") || title.Contains("hair stylist"))
				m_PersonalityType = NPCPersonalities.PersonalityType.HairStylist;
			else if (typeName.Contains("Gypsy") || title.Contains("gypsy"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Gypsy;
			else if (typeName.Contains("Actor") || title.Contains("actor") || title.Contains("actress"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Actor;
			else if (title.Contains("guard") || title.Contains("militia") || title.Contains("cannoneer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Guard;
			else if (title.Contains("ranger"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Ranger;
			else if (title.Contains("wise") || title.Contains("scholar") || title.Contains("student") || title.Contains("researcher") || title.Contains("professor") || title.Contains("the blind"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Sage; // Scholar maps to Sage
			else if (title.Contains("naturalist"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Herbalist; // Naturalist maps to Herbalist
			else if (title.Contains("monk"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Monk;
			else if (title.Contains("paladin") || title.Contains("keeper of chivalry"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Paladin;
			else if (title.Contains("thief"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Thief;
			else if (title.Contains("pirate"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Pirate;
			else if (title.Contains("necromancer"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Mage; // Necromancer maps to Mage (dark magic specialist)
			else if (title.Contains("noble"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Noble;
			else if (title.Contains("beggar"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Beggar;
			else if (title.Contains("peasant"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Peasant;
			else if (title.Contains("vagabond"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Vagabond;
			else if (title.Contains("merchant"))
				m_PersonalityType = NPCPersonalities.PersonalityType.Merchant;
			else
				m_PersonalityType = NPCPersonalities.PersonalityType.Merchant; // Default for all other vendors
		}
		#endregion
			...
			: base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 5)
		{
			...
			// Initialize LLM personality based on vendor type
			InferPersonality();
		}
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			// Version 4: LLM conversation support
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			// Re-infer personality based on current title (in case title was changed or detection improved)
			InferPersonality();
