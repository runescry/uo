    ...
    public class MapDefinitions
    {
        public static void Configure()
        {
            ...
            */
            ...
            // Custom map: Vystia (map9.mul) - 7168x4096 tiles (same as Felucca)
            // Map files located in C:\Vystia_Map\ and must be copied to client directory
            // See VYSTIA_MAP_SETUP.md for client setup instructions
            RegisterMap(9, 9, 9, 7168, 4096, 1, "Vystia", MapRules.TrammelRules);
