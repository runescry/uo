...
3. **[TESTING_GUIDE.md](TESTING_GUIDE.md)** - Comprehensive testing guide for all Vystia systems
4. **[CLAUDE.md](CLAUDE.md)** - AI assistant context with code patterns and examples

## Reference Documentation

5. **[RESOURCE_CORRECTIONS.md](RESOURCE_CORRECTIONS.md)** - Vystia resource catalog and regional mappings
6. **[Systems/RELIGION_FACTION_CRAFTING_INTEGRATION.md](Systems/RELIGION_FACTION_CRAFTING_INTEGRATION.md)** - Religion, faction, and crafting integration details
7. **[KNOWN_ISSUES.md](KNOWN_ISSUES.md)** - Current build errors (5 pre-existing, none from classes)
