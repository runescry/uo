...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class ElementalVolcanicEruptionSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Volcanic Eruption", "Volcanicum Eruptionum",
            203,
            9041,
            false
        );
        ...
        public ElementalVolcanicEruptionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Spell effect
                // Deal damage
                double damage = Utility.RandomMinMax(40, 70);
        ...
        {
            private readonly ElementalVolcanicEruptionSpell m_Owner;

            public InternalTarget(ElementalVolcanicEruptionSpell owner)
