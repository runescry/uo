...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class ElementalSmokeScreenSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Smoke Screen", "Smokeus Screenum",
            203,
            9041,
            false
        );
        ...
        public ElementalSmokeScreenSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Smoke Screen - Smoke Screen Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalSmokeScreen_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalSmokeScreen!");
        ...
        {
            private readonly ElementalSmokeScreenSpell m_Owner;

            public InternalTarget(ElementalSmokeScreenSpell owner)
