...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class ElementalIgniteSpell : VystiaSpell
    {
        ...
        public ElementalIgniteSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Ignite - Ignite Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalIgnite_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalIgnite!");
        ...
        {
            private readonly ElementalIgniteSpell m_Owner;

            public InternalTarget(ElementalIgniteSpell owner)
