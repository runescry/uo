...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class ElementalLavaFlowSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Lava Flow", "Lavaum Flowum",
            203,
            9041,
            false
        );
        ...
        public ElementalLavaFlowSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Lava Flow - Lava Flow Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalLavaFlow_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalLavaFlow!");
        ...
        {
            private readonly ElementalLavaFlowSpell m_Owner;

            public InternalTarget(ElementalLavaFlowSpell owner)
