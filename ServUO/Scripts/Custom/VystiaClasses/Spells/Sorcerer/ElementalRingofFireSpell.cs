...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class ElementalRingofFireSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Ring of Fire", "Ringum Ofum Ignis",
            203,
            9041,
            false
        );
        ...
        public ElementalRingofFireSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Spell effect
                // Deal damage
                double damage = Utility.RandomMinMax(3, 6);
        ...
        {
            private readonly ElementalRingofFireSpell m_Owner;

            public InternalTarget(ElementalRingofFireSpell owner)
