...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class ElementalFlameWardSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Flame Ward", "Flameus Wardum",
            203,
            9041,
            false
        );
        ...
        public ElementalFlameWardSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Flame Ward - Flame Ward Circle: 2 (8 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalFlameWard_Int", -2, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalFlameWard!");
        ...
        {
            private readonly ElementalFlameWardSpell m_Owner;

            public InternalTarget(ElementalFlameWardSpell owner)
