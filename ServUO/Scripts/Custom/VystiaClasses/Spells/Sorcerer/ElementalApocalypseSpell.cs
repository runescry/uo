...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 8 (32 mana)
    /// </summary>
    public class ElementalApocalypseSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Apocalypse", "Apocalypseus",
            203,
            9041,
            false
        );
        ...
        public ElementalApocalypseSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ElementalApocalypseSpell m_Owner;

            public InternalTarget(ElementalApocalypseSpell owner)
