...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class ElementalCataclysmSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Cataclysm", "Cataclysmum",
            203,
            9041,
            false
        );
        ...
        public ElementalCataclysmSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Spell effect
                // Deal damage
                double damage = Utility.RandomMinMax(50, 85);
        ...
        {
            private readonly ElementalCataclysmSpell m_Owner;

            public InternalTarget(ElementalCataclysmSpell owner)
