...
{
    /// <summary>
    /// Lava Puddle - Lava Puddle
    /// Circle: 2 (8 mana)
    /// </summary>
    public class ElementalLavaPuddleSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Lava Puddle", "Lavaum Puddleus",
            203,
            9041,
            false
        );
        ...
        public ElementalLavaPuddleSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ElementalLavaPuddleSpell m_Owner;

            public InternalTarget(ElementalLavaPuddleSpell owner)
