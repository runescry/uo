...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class ElementalMeteorStrikeSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Meteor Strike", "Meteorum Strikeus",
            203,
            9041,
            false
        );
        ...
        public ElementalMeteorStrikeSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ElementalMeteorStrikeSpell m_Owner;

            public InternalTarget(ElementalMeteorStrikeSpell owner)
