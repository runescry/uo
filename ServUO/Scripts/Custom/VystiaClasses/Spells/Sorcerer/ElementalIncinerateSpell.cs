...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class ElementalIncinerateSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Incinerate", "Incinerateus",
            203,
            9041,
            false
        );
        ...
        public ElementalIncinerateSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Incinerate - Incinerate Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalIncinerate_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalIncinerate!");
        ...
        {
            private readonly ElementalIncinerateSpell m_Owner;

            public InternalTarget(ElementalIncinerateSpell owner)
