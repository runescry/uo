...
{
    /// <summary>
    /// Flame Tempest - Flame Tempest
    /// Circle: 6 (24 mana)
    /// </summary>
    public class ElementalFlameTempestSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Flame Tempest", "Flameus Tempestum",
            203,
            9041,
            false
        );
        ...
        public ElementalFlameTempestSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ElementalFlameTempestSpell m_Owner;

            public InternalTarget(ElementalFlameTempestSpell owner)
