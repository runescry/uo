...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class ElementalPyroclasticFlowSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Pyroclastic Flow", "Pyroclasticum Flowum",
            203,
            9041,
            false
        );
        ...
        public ElementalPyroclasticFlowSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Spell effect
                // Deal damage
                double damage = Utility.RandomMinMax(60, 100);
        ...
        {
            private readonly ElementalPyroclasticFlowSpell m_Owner;

            public InternalTarget(ElementalPyroclasticFlowSpell owner)
