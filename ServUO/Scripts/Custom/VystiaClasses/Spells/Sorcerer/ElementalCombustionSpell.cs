...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class ElementalCombustionSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Combustion", "Combustionum",
            203,
            9041,
            false
        );
        ...
        public ElementalCombustionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ElementalCombustionSpell m_Owner;

            public InternalTarget(ElementalCombustionSpell owner)
