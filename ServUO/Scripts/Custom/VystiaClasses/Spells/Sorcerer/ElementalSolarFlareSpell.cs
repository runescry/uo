...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 8 (32 mana)
    /// </summary>
    public class ElementalSolarFlareSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Solar Flare", "Solarum Flareus",
            203,
            9041,
            false
        );
        ...
        public ElementalSolarFlareSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Spell effect
                // Deal damage
                double damage = Utility.RandomMinMax(100, 160);
        ...
        {
            private readonly ElementalSolarFlareSpell m_Owner;

            public InternalTarget(ElementalSolarFlareSpell owner)
