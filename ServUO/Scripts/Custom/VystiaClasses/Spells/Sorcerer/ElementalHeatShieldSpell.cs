...
namespace Server.Spells.VystiaSpells.Elemental
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class ElementalHeatShieldSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Heat Shield", "Heatum Scutum",
            203,
            9041,
            false
        );
        ...
        public ElementalHeatShieldSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Heat Shield - Heat Shield Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ElementalHeatShield_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ElementalHeatShield!");
        ...
        {
            private readonly ElementalHeatShieldSpell m_Owner;

            public InternalTarget(ElementalHeatShieldSpell owner)
