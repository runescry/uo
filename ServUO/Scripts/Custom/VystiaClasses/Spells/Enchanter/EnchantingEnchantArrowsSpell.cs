...
{
    /// <summary>
    /// Enchant Arrows - Enchant Arrows
    /// Circle: 4 (16 mana)
    /// </summary>
    public class EnchantingEnchantArrowsSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Enchant Arrows", "Enchantum Arrowsum",
            203,
            9041,
            false
        );
        ...
        public EnchantingEnchantArrowsSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly EnchantingEnchantArrowsSpell m_Owner;

            public InternalTarget(EnchantingEnchantArrowsSpell owner)
