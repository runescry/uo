...
namespace Server.Spells.VystiaSpells.Enchanting
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class EnchantingSharpenSpell : VystiaSpell
    {
        ...
        public EnchantingSharpenSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Sharpen - Sharpen Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "EnchantingSharpen_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by EnchantingSharpen!");
        ...
        {
            private readonly EnchantingSharpenSpell m_Owner;

            public InternalTarget(EnchantingSharpenSpell owner)
