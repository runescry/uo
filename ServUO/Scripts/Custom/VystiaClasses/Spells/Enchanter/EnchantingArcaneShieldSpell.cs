...
namespace Server.Spells.VystiaSpells.Enchanting
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class EnchantingArcaneShieldSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Arcane Shield", "Arcaneus Scutum",
            203,
            9041,
            false
        );
        ...
        public EnchantingArcaneShieldSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Arcane Shield - Arcane Shield Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "EnchantingArcaneShield_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by EnchantingArcaneShield!");
        ...
        {
            private readonly EnchantingArcaneShieldSpell m_Owner;

            public InternalTarget(EnchantingArcaneShieldSpell owner)
