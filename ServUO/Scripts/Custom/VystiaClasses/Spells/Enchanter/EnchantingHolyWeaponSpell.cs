...
namespace Server.Spells.VystiaSpells.Enchanting
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class EnchantingHolyWeaponSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Holy Weapon", "Holyum Weaponum",
            203,
            9041,
            false
        );
        ...
        public EnchantingHolyWeaponSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Holy Weapon - Holy Weapon Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "EnchantingHolyWeapon_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by EnchantingHolyWeapon!");
        ...
        {
            private readonly EnchantingHolyWeaponSpell m_Owner;

            public InternalTarget(EnchantingHolyWeaponSpell owner)
