...
namespace Server.Spells.VystiaSpells.Enchanting
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class EnchantingRuneofPowerSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Rune of Power", "Runeus Ofum Powerum",
            203,
            9041,
            false
        );
        ...
        public EnchantingRuneofPowerSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Rune of Power - Rune of Power Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "EnchantingRuneofPower_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by EnchantingRuneofPower!");
        ...
        {
            private readonly EnchantingRuneofPowerSpell m_Owner;

            public InternalTarget(EnchantingRuneofPowerSpell owner)
