...
namespace Server.Spells.VystiaSpells.Enchanting
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class EnchantingMagicWeaponSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Magic Weapon", "Magicum Weaponum",
            203,
            9041,
            false
        );
        ...
        public EnchantingMagicWeaponSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Magic Weapon - Magic Weapon Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "EnchantingMagicWeapon_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by EnchantingMagicWeapon!");
        ...
        {
            private readonly EnchantingMagicWeaponSpell m_Owner;

            public InternalTarget(EnchantingMagicWeaponSpell owner)
