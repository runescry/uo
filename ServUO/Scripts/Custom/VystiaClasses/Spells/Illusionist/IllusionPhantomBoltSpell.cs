...
{
    /// <summary>
    /// Phantom Bolt - Phantom Bolt
    /// Circle: 2 (8 mana)
    /// </summary>
    public class IllusionPhantomBoltSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Phantom Bolt", "Phantomum Sagitta",
            203,
            9041,
            false
        );
        ...
        public IllusionPhantomBoltSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly IllusionPhantomBoltSpell m_Owner;

            public InternalTarget(IllusionPhantomBoltSpell owner)
