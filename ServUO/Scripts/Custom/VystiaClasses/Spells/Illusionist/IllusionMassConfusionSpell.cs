...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class IllusionMassConfusionSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mass Confusion", "Massum Confusionum",
            203,
            9041,
            false
        );
        ...
        public IllusionMassConfusionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Mass Confusion - Mass Confusion Circle: 4 (16 mana)
                target.AddStatMod(new StatMod(StatType.Int, "IllusionMassConfusion_Int", -4, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by IllusionMassConfusion!");
        ...
        {
            private readonly IllusionMassConfusionSpell m_Owner;

            public InternalTarget(IllusionMassConfusionSpell owner)
