...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class IllusionMindBlastSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mind Blast", "Mindum Eruptio",
            203,
            9041,
            false
        );
        ...
        public IllusionMindBlastSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly IllusionMindBlastSpell m_Owner;

            public InternalTarget(IllusionMindBlastSpell owner)
