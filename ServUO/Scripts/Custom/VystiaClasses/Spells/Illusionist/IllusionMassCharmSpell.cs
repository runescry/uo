...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class IllusionMassCharmSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mass Charm", "Massum Charmum",
            203,
            9041,
            false
        );
        ...
        public IllusionMassCharmSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (CheckSequence())
            {
                ...
                // Mass Charm - Mass Charm Circle: 6 (24 mana)
                ...
                foreach (Mobile m in targets)
                {
                    ...
                    double damage = Utility.RandomMinMax(35, 87);
        ...
        {
            private readonly IllusionMassCharmSpell m_Owner;

            public InternalTarget(IllusionMassCharmSpell owner)
