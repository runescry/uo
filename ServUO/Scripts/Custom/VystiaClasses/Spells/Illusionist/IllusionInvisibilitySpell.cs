...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class IllusionInvisibilitySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Invisibility", "Invisibilityum",
            203,
            9041,
            false
        );
        ...
        public IllusionInvisibilitySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckBSequence(target))
            {
                ...
                // Invisibility - Invisibility Circle: 2 (8 mana)
                target.Hidden = true;
        ...
        {
            private readonly IllusionInvisibilitySpell m_Owner;

            public InternalTarget(IllusionInvisibilitySpell owner)
