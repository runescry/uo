...
{
    /// <summary>
    /// Perfect Invisibility - Perfect Invisibility
    /// Circle: 5 (20 mana)
    /// </summary>
    public class IllusionPerfectInvisibilitySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Perfect Invisibility", "Perfectum Invisibilityum",
            203,
            9041,
            false
        );
        ...
        public IllusionPerfectInvisibilitySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckBSequence(target))
            {
                ...
                // Perfect Invisibility - Perfect Invisibility Circle: 5 (20 mana)
                target.Hidden = true;
        ...
        {
            private readonly IllusionPerfectInvisibilitySpell m_Owner;

            public InternalTarget(IllusionPerfectInvisibilitySpell owner)
