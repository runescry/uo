...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class IllusionRealityWarpSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Reality Warp", "Realityum Warpum",
            203,
            9041,
            false
        );
        ...
        public IllusionRealityWarpSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Reality Warp - Reality Warp Circle: 7 (28 mana)
                target.AddStatMod(new StatMod(StatType.Int, "IllusionRealityWarp_Int", -7, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by IllusionRealityWarp!");
        ...
        {
            private readonly IllusionRealityWarpSpell m_Owner;

            public InternalTarget(IllusionRealityWarpSpell owner)
