...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class IllusionPsychicScreamSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Psychic Scream", "Psychicum Screamum",
            203,
            9041,
            false
        );
        ...
        public IllusionPsychicScreamSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Psychic Scream - Psychic Scream Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "IllusionPsychicScream_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by IllusionPsychicScream!");
        ...
        {
            private readonly IllusionPsychicScreamSpell m_Owner;

            public InternalTarget(IllusionPsychicScreamSpell owner)
