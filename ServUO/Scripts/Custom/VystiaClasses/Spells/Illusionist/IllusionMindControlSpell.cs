...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class IllusionMindControlSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mind Control", "Mindum Controlum",
            203,
            9041,
            false
        );
        ...
        public IllusionMindControlSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Mind Control - Mind Control Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "IllusionMindControl_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by IllusionMindControl!");
        ...
        {
            private readonly IllusionMindControlSpell m_Owner;

            public InternalTarget(IllusionMindControlSpell owner)
