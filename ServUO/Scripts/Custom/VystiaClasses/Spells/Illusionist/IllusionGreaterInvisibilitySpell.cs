...
namespace Server.Spells.VystiaSpells.Illusion
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class IllusionGreaterInvisibilitySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Greater Invisibility", "Greaterum Invisibilityum",
            203,
            9041,
            false
        );
        ...
        public IllusionGreaterInvisibilitySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckBSequence(target))
            {
                ...
                // Greater Invisibility - Greater Invisibility Circle: 3 (12 mana)
                target.Hidden = true;
        ...
        {
            private readonly IllusionGreaterInvisibilitySpell m_Owner;

            public InternalTarget(IllusionGreaterInvisibilitySpell owner)
