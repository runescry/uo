...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class SummoningSummonEarthElementalSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Earth Elemental", "Summonum Earthum Elementalum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonEarthElementalSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
