...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class SummoningSummonAirElementalSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Air Elemental", "Summonum Airum Elementalum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonAirElementalSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
