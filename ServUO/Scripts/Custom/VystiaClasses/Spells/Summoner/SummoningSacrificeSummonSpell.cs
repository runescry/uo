...
{
    /// <summary>
    /// Sacrifice Summon - Sacrifice Summon
    /// Circle: 7 (28 mana)
    /// </summary>
    public class SummoningSacrificeSummonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Sacrifice Summon", "Sacrificeus Summonum",
            203,
            9041,
            false
        );
        ...
        public SummoningSacrificeSummonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
