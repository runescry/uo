...
{
    /// <summary>
    /// Summon Storm Elemental - Summon Storm Elemental
    /// Circle: 5 (20 mana)
    /// </summary>
    public class SummoningSummonStormElementalSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Storm Elemental", "Summonum Stormum Elementalum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonStormElementalSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature creature = new AirElemental();
