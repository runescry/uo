...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class SummoningArcaneBoltSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Arcane Bolt", "Arcaneus Sagitta",
            203,
            9041,
            false
        );
        ...
        public SummoningArcaneBoltSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly SummoningArcaneBoltSpell m_Owner;

            public InternalTarget(SummoningArcaneBoltSpell owner)
