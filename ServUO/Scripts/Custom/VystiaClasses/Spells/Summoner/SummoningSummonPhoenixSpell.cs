...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class SummoningSummonPhoenixSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Phoenix", "Summonum Phoenixum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonPhoenixSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature creature = new Phoenix();
