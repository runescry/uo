...
{
    /// <summary>
    /// Empower Summon - Empower Summon
    /// Circle: 1 (4 mana)
    /// </summary>
    public class SummoningEmpowerSummonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Empower Summon", "Empowerum Summonum",
            203,
            9041,
            false
        );
        ...
        public SummoningEmpowerSummonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
