...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class SummoningSummonRabbitSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Rabbit", "Summonum Rabbitum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonRabbitSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature creature = new Rabbit();
