...
{
    /// <summary>
    /// Greater Heal Summon - Greater Heal Summon
    /// Circle: 5 (20 mana)
    /// </summary>
    public class SummoningGreaterHealSummonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Greater Heal Summon", "Greaterum Sanitas Summonum",
            203,
            9041,
            false
        );
        ...
        public SummoningGreaterHealSummonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly SummoningGreaterHealSummonSpell m_Owner;

            public InternalTarget(SummoningGreaterHealSummonSpell owner)
