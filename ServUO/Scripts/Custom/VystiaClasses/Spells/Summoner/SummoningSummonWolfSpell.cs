...
namespace Server.Spells.VystiaSpells.Summoning
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class SummoningSummonWolfSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Wolf", "Summonum Wolfum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonWolfSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
