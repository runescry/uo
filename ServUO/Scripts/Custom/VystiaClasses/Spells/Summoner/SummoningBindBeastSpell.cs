...
{
    /// <summary>
    /// Bind Beast - Bind Beast
    /// Circle: 3 (12 mana)
    /// </summary>
    public class SummoningBindBeastSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Bind Beast", "Bindum Beastum",
            203,
            9041,
            false
        );
        ...
        public SummoningBindBeastSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Bind Beast - Bind Beast Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "SummoningBindBeast_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by SummoningBindBeast!");
        ...
        {
            private readonly SummoningBindBeastSpell m_Owner;

            public InternalTarget(SummoningBindBeastSpell owner)
