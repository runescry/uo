...
{
    /// <summary>
    /// Summon Elemental Lord - Summon Elemental Lord
    /// Circle: 7 (28 mana)
    /// </summary>
    public class SummoningSummonElementalLordSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Elemental Lord", "Summonum Elementalum Lordum",
            203,
            9041,
            false
        );
        ...
        public SummoningSummonElementalLordSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
