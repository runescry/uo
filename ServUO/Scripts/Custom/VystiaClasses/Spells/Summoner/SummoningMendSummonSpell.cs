...
{
    /// <summary>
    /// Mend Summon - Mend Summon
    /// Circle: 2 (8 mana)
    /// </summary>
    public class SummoningMendSummonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mend Summon", "Mendum Summonum",
            203,
            9041,
            false
        );
        ...
        public SummoningMendSummonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly SummoningMendSummonSpell m_Owner;

            public InternalTarget(SummoningMendSummonSpell owner)
