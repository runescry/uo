...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class NecromancyVampiricTouchSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Vampiric Touch", "Vampiricum Tactus",
            203,
            9041,
            false
        );
        ...
        public NecromancyVampiricTouchSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyVampiricTouchSpell m_Owner;

            public InternalTarget(NecromancyVampiricTouchSpell owner)
