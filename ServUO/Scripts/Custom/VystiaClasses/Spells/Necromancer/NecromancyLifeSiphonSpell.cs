...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class NecromancyLifeSiphonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Life Siphon", "Vita Siphonum",
            203,
            9041,
            false
        );
        ...
        public NecromancyLifeSiphonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyLifeSiphonSpell m_Owner;

            public InternalTarget(NecromancyLifeSiphonSpell owner)
