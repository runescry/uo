...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class NecromancySoulShieldSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Soul Shield", "Soulum Scutum",
            203,
            9041,
            false
        );
        ...
        public NecromancySoulShieldSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancySoulShieldSpell m_Owner;

            public InternalTarget(NecromancySoulShieldSpell owner)
