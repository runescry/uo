...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class NecromancyUnholyFrenzySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Unholy Frenzy", "Unholyum Frenzyum",
            203,
            9041,
            false
        );
        ...
        public NecromancyUnholyFrenzySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Unholy Frenzy - Unholy Frenzy Circle: 6 (24 mana)
                target.AddStatMod(new StatMod(StatType.Int, "NecromancyUnholyFrenzy_Int", -6, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by NecromancyUnholyFrenzy!");
        ...
        {
            private readonly NecromancyUnholyFrenzySpell m_Owner;

            public InternalTarget(NecromancyUnholyFrenzySpell owner)
