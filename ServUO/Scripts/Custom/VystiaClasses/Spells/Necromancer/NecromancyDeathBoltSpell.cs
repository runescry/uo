...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class NecromancyDeathBoltSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Death Bolt", "Mors Sagitta",
            203,
            9041,
            false
        );
        ...
        public NecromancyDeathBoltSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyDeathBoltSpell m_Owner;

            public InternalTarget(NecromancyDeathBoltSpell owner)
