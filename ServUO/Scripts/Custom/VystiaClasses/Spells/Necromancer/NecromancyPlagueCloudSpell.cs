...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class NecromancyPlagueCloudSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Plague Cloud", "Plagueus Cloudum",
            203,
            9041,
            false
        );
        ...
        public NecromancyPlagueCloudSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
            ...
            else if (CheckHSequence(target))
            {
                ...
                Timer.DelayCall(TimeSpan.Zero, TimeSpan.FromSeconds(5), ticks, () =>
                {
                    if (target is Mobile mobile && !mobile.Deleted && mobile.Alive)
                    {
                        ...
                        mobile.FixedParticles(0x37C4, 10, 15, 5021, EffectLayer.Waist);
                    }
                });
        ...
        {
            private readonly NecromancyPlagueCloudSpell m_Owner;

            public InternalTarget(NecromancyPlagueCloudSpell owner)
