...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class NecromancyDeathCoilSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Death Coil", "Mors Coilum",
            203,
            9041,
            false
        );
        ...
        public NecromancyDeathCoilSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyDeathCoilSpell m_Owner;

            public InternalTarget(NecromancyDeathCoilSpell owner)
