...
{
    /// <summary>
    /// Raise Bone Golem - Raise Bone Golem
    /// Circle: 5 (20 mana)
    /// </summary>
    public class NecromancyRaiseBoneGolemSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Raise Bone Golem", "Raiseus Boneus Golemum",
            203,
            9041,
            false
        );
        ...
        public NecromancyRaiseBoneGolemSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
