...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 8 (32 mana)
    /// </summary>
    public class NecromancyDeathsDoorSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Death's Door", "Death'sum Doorum",
            203,
            9041,
            false
        );
        ...
        public NecromancyDeathsDoorSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Death's Door - Death's Door Circle: 8 (32 mana)
                target.AddStatMod(new StatMod(StatType.Int, "NecromancyDeathsDoor_Int", -8, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by NecromancyDeathsDoor!");
        ...
        {
            private readonly NecromancyDeathsDoorSpell m_Owner;

            public InternalTarget(NecromancyDeathsDoorSpell owner)
