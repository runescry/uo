...
{
    /// <summary>
    /// Mass Raise - Mass Raise
    /// Circle: 3 (12 mana)
    /// </summary>
    public class NecromancyMassRaiseSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mass Raise", "Massum Raiseus",
            203,
            9041,
            false
        );
        ...
        public NecromancyMassRaiseSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
