...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class NecromancyBoneWallSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Bone Wall", "Boneus Wallum",
            203,
            9041,
            false
        );
        ...
        public NecromancyBoneWallSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Bone Wall - Bone Wall Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "NecromancyBoneWall_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by NecromancyBoneWall!");
        ...
        {
            private readonly NecromancyBoneWallSpell m_Owner;

            public InternalTarget(NecromancyBoneWallSpell owner)
