...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class NecromancySoulHarvestSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Soul Harvest", "Soulum Harvestum",
            203,
            9041,
            false
        );
        ...
        public NecromancySoulHarvestSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Soul Harvest - Soul Harvest Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "NecromancySoulHarvest_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by NecromancySoulHarvest!");
        ...
        {
            private readonly NecromancySoulHarvestSpell m_Owner;

            public InternalTarget(NecromancySoulHarvestSpell owner)
