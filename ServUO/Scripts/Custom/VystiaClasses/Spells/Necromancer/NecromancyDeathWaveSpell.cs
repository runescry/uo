...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class NecromancyDeathWaveSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Death Wave", "Mors Waveus",
            203,
            9041,
            false
        );
        ...
        public NecromancyDeathWaveSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyDeathWaveSpell m_Owner;

            public InternalTarget(NecromancyDeathWaveSpell owner)
