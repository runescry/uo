...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class NecromancyBoneShardSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Bone Shard", "Boneus Shardum",
            203,
            9041,
            false
        );
        ...
        public NecromancyBoneShardSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyBoneShardSpell m_Owner;

            public InternalTarget(NecromancyBoneShardSpell owner)
