...
namespace Server.Spells.VystiaSpells.Necromancy
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class NecromancyDeathGripSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Death Grip", "Mors Gripum",
            203,
            9041,
            false
        );
        ...
        public NecromancyDeathGripSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly NecromancyDeathGripSpell m_Owner;

            public InternalTarget(NecromancyDeathGripSpell owner)
