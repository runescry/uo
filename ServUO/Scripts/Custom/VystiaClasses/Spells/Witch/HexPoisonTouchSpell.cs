...
{
    /// <summary>
    /// Poison Touch - Applies Greater Poison (5-8 damage/tick)
    /// Circle: 2 (6 mana)
    /// </summary>
    public class HexPoisonTouchSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Poison Touch", "Venenum Tactus",
            203,
            9041,
            false
        );
        ...
        public HexPoisonTouchSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexPoisonTouchSpell m_Owner;

            public InternalTarget(HexPoisonTouchSpell owner)
