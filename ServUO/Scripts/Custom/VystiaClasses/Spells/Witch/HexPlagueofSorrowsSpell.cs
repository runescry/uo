...
{
    /// <summary>
    /// Plague of Sorrows - Contagious mega-plague: 10-18 damage/tick, spreads to anyone within 5 tiles, reduces healing 75%
    /// Circle: 7 (40 mana)
    /// </summary>
    public class HexPlagueofSorrowsSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Plague of Sorrows", "Plagueus Ofum Sorrowsum",
            203,
            9041,
            false
        );
        ...
        public HexPlagueofSorrowsSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexPlagueofSorrowsSpell m_Owner;

            public InternalTarget(HexPlagueofSorrowsSpell owner)
