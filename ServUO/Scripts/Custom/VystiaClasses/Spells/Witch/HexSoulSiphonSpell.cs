...
{
    /// <summary>
    /// Soul Siphon - Drains 35-55 HP, heals caster for 200% of amount, grants temporary +10% max HP buff (60s)
    /// Circle: 5 (14 mana)
    /// </summary>
    public class HexSoulSiphonSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Soul Siphon", "Soulum Siphonum",
            203,
            9041,
            false
        );
        ...
        public HexSoulSiphonSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexSoulSiphonSpell m_Owner;

            public InternalTarget(HexSoulSiphonSpell owner)
