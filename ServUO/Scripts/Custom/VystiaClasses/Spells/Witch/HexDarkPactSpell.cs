...
{
    /// <summary>
    /// Dark Pact - Sacrifice 15% current HP, gain +20% spell damage for duration
    /// Circle: 2 (6 mana)
    /// </summary>
    public class HexDarkPactSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Dark Pact", "Darkum Pactum",
            203,
            9041,
            false
        );
        ...
        public HexDarkPactSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Dark Pact - Sacrifice 15% current HP, gain +20% spell damage for duration Circle: 2 (6 mana)
        ...
        {
            private readonly HexDarkPactSpell m_Owner;

            public InternalTarget(HexDarkPactSpell owner)
