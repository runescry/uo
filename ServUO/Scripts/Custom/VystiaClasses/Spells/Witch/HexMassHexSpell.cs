...
{
    /// <summary>
    /// Mass Hex - All enemies cursed: -10 all stats, -10% damage, -5 all resists
    /// Circle: 5 (14 mana)
    /// </summary>
    public class HexMassHexSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mass Hex", "Massum Hexum",
            203,
            9041,
            false
        );
        ...
        public HexMassHexSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (CheckSequence())
            {
                ...
                // Mass Hex - All enemies cursed: -10 all stats, -10% damage, -5 all resists Circle: 5 (14 mana)
                ...
                foreach (Mobile m in targets)
                {
                    ...
                    double damage = Utility.RandomMinMax(30, 75);
        ...
        {
            private readonly HexMassHexSpell m_Owner;

            public InternalTarget(HexMassHexSpell owner)
