...
{
    /// <summary>
    /// Witch Sight - Reveals hidden creatures, see in darkness, detect magic auras
    /// Circle: 1 (4 mana)
    /// </summary>
    public class HexWitchSightSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Witch Sight", "Witchum Sightum",
            203,
            9041,
            false
        );
        ...
        public HexWitchSightSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckBSequence(target))
            {
                ...
                // Witch Sight - Reveals hidden creatures, see in darkness, detect magic auras Circle: 1 (4 mana)
                target.Hidden = true;
        ...
        {
            private readonly HexWitchSightSpell m_Owner;

            public InternalTarget(HexWitchSightSpell owner)
