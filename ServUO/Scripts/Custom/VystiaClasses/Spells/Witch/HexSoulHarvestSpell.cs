...
{
    /// <summary>
    /// Soul Harvest - Drains 40-65 HP from all enemies, heals caster for total amount drained, grants shield equal to healing
    /// Circle: 7 (40 mana)
    /// </summary>
    public class HexSoulHarvestSpell : VystiaSpell
    {
        ...
        public HexSoulHarvestSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexSoulHarvestSpell m_Owner;

            public InternalTarget(HexSoulHarvestSpell owner)
