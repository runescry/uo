...
{
    /// <summary>
    /// Witch Queen's Dominion - Become Witch Queen: All hexes cost 50% less mana, hexes last twice as long, life drain heals 300%, immune to curses/poison, summons 3 hex totems that auto-curse enemies
    /// Circle: 8 (50 mana)
    /// </summary>
    public class HexWitchQueensDominionSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Witch Queen's Dominion", "Witchum Queen'sum Dominionum",
            203,
            9041,
            false
        );
        ...
        public HexWitchQueensDominionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexWitchQueensDominionSpell m_Owner;

            public InternalTarget(HexWitchQueensDominionSpell owner)
