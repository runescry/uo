...
{
    /// <summary>
    /// Siphon Life - Drains 6-12 HP from target, heals caster for same amount
    /// Circle: 1 (4 mana)
    /// </summary>
    public class HexSiphonLifeSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Siphon Life", "Siphonum Vita",
            203,
            9041,
            false
        );
        ...
        public HexSiphonLifeSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly HexSiphonLifeSpell m_Owner;

            public InternalTarget(HexSiphonLifeSpell owner)
