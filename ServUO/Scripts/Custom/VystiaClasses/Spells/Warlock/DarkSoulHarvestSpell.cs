...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class DarkSoulHarvestSpell : VystiaSpell
    {
        ...
        public DarkSoulHarvestSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Soul Harvest - Soul Harvest Circle: 7 (28 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkSoulHarvest_Int", -7, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkSoulHarvest!");
        ...
        {
            private readonly DarkSoulHarvestSpell m_Owner;

            public InternalTarget(DarkSoulHarvestSpell owner)
