...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class DarkShadowStepSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Shadow Step", "Umbra Stepum",
            203,
            9041,
            false
        );
        ...
        public DarkShadowStepSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Shadow Step - Shadow Step Circle: 2 (8 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkShadowStep_Int", -2, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkShadowStep!");
        ...
        {
            private readonly DarkShadowStepSpell m_Owner;

            public InternalTarget(DarkShadowStepSpell owner)
