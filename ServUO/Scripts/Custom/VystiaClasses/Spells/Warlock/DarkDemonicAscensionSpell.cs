...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class DarkDemonicAscensionSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Demonic Ascension", "Demonicum Ascensionum",
            203,
            9041,
            false
        );
        ...
        public DarkDemonicAscensionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Demonic Ascension - Demonic Ascension Circle: 7 (28 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkDemonicAscension_Int", -7, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkDemonicAscension!");
        ...
        {
            private readonly DarkDemonicAscensionSpell m_Owner;

            public InternalTarget(DarkDemonicAscensionSpell owner)
