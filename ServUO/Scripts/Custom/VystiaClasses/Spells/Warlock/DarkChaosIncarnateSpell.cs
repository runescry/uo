...
{
    /// <summary>
    /// Chaos Incarnate - Chaos Incarnate
    /// Circle: 8 (32 mana)
    /// </summary>
    public class DarkChaosIncarnateSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Chaos Incarnate", "Chaosum Incarnateus",
            203,
            9041,
            false
        );
        ...
        public DarkChaosIncarnateSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Chaos Incarnate - Chaos Incarnate Circle: 8 (32 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkChaosIncarnate_Int", -8, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkChaosIncarnate!");
        ...
        {
            private readonly DarkChaosIncarnateSpell m_Owner;

            public InternalTarget(DarkChaosIncarnateSpell owner)
