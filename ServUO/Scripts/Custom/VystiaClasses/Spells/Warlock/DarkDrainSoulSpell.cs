...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class DarkDrainSoulSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drain Soul", "Drainum Soulum",
            203,
            9041,
            false
        );
        ...
        public DarkDrainSoulSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly DarkDrainSoulSpell m_Owner;

            public InternalTarget(DarkDrainSoulSpell owner)
