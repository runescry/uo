...
{
    /// <summary>
    /// Minor Fear - Minor Fear
    /// Circle: 1 (4 mana)
    /// </summary>
    public class DarkMinorFearSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Minor Fear", "Minorum Fearum",
            203,
            9041,
            false
        );
        ...
        public DarkMinorFearSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Minor Fear - Minor Fear Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkMinorFear_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkMinorFear!");
        ...
        {
            private readonly DarkMinorFearSpell m_Owner;

            public InternalTarget(DarkMinorFearSpell owner)
