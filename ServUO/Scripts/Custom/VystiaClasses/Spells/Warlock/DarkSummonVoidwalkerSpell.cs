...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class DarkSummonVoidwalkerSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Voidwalker", "Summonum Voidwalkerum",
            203,
            9041,
            false
        );
        ...
        public DarkSummonVoidwalkerSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
