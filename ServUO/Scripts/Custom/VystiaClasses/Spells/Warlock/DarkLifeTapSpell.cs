...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class DarkLifeTapSpell : VystiaSpell
    {
        ...
        public DarkLifeTapSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Life Tap - Life Tap Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DarkLifeTap_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DarkLifeTap!");
        ...
        {
            private readonly DarkLifeTapSpell m_Owner;

            public InternalTarget(DarkLifeTapSpell owner)
