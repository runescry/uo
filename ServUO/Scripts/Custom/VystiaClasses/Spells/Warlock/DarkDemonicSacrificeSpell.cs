...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class DarkDemonicSacrificeSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Demonic Sacrifice", "Demonicum Sacrificeus",
            203,
            9041,
            false
        );
        ...
        public DarkDemonicSacrificeSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly DarkDemonicSacrificeSpell m_Owner;

            public InternalTarget(DarkDemonicSacrificeSpell owner)
