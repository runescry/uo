...
namespace Server.Spells.VystiaSpells.Dark
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class DarkFearWaveSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Fear Wave", "Fearum Waveus",
            203,
            9041,
            false
        );
        ...
        public DarkFearWaveSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly DarkFearWaveSpell m_Owner;

            public InternalTarget(DarkFearWaveSpell owner)
