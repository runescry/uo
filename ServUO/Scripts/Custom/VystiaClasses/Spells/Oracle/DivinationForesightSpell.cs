...
namespace Server.Spells.VystiaSpells.Divination
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class DivinationForesightSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Foresight", "Foresightum",
            203,
            9041,
            false
        );
        ...
        public DivinationForesightSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Foresight - Foresight Circle: 2 (8 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DivinationForesight_Int", -2, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DivinationForesight!");
        ...
        {
            private readonly DivinationForesightSpell m_Owner;

            public InternalTarget(DivinationForesightSpell owner)
