...
namespace Server.Spells.VystiaSpells.Divination
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class DivinationMassHasteSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Mass Haste", "Massum Hasteus",
            203,
            9041,
            false
        );
        ...
        public DivinationMassHasteSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Mass Haste - Mass Haste Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "DivinationMassHaste_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by DivinationMassHaste!");
        ...
        {
            private readonly DivinationMassHasteSpell m_Owner;

            public InternalTarget(DivinationMassHasteSpell owner)
