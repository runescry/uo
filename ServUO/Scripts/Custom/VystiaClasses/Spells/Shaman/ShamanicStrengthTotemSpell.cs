...
{
    /// <summary>
    /// Strength Totem - Strength Totem
    /// Circle: 1 (4 mana)
    /// </summary>
    public class ShamanicStrengthTotemSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Strength Totem", "Strengthum Totemum",
            203,
            9041,
            false
        );
        ...
        public ShamanicStrengthTotemSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Strength Totem - Strength Totem Circle: 1 (4 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicStrengthTotem_Totem", 10, TimeSpan.FromMinutes(duration)));
