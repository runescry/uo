...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class ShamanicSpiritLinkTotemSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Spirit Link Totem", "Spiritum Linkum Totemum",
            203,
            9041,
            false
        );
        ...
        public ShamanicSpiritLinkTotemSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Spirit Link Totem - Spirit Link Totem Circle: 6 (24 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicSpiritLinkTotem_Totem", 10, TimeSpan.FromMinutes(duration)));
