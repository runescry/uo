...
{
    /// <summary>
    /// Shaman Lord - Shaman Lord
    /// Circle: 8 (32 mana)
    /// </summary>
    public class ShamanicShamanLordSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Shaman Lord", "Shamanum Lordum",
            203,
            9041,
            false
        );
        ...
        public ShamanicShamanLordSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Shaman Lord - Shaman Lord Circle: 8 (32 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ShamanicShamanLord_Int", -8, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ShamanicShamanLord!");
        ...
        {
            private readonly ShamanicShamanLordSpell m_Owner;

            public InternalTarget(ShamanicShamanLordSpell owner)
