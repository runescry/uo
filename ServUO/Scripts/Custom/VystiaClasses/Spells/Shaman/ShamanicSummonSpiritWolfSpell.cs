...
{
    /// <summary>
    /// Summon Spirit Wolf - Summon Spirit Wolf
    /// Circle: 3 (12 mana)
    /// </summary>
    public class ShamanicSummonSpiritWolfSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Summon Spirit Wolf", "Summonum Spiritum Wolfum",
            203,
            9041,
            false
        );
        ...
        public ShamanicSummonSpiritWolfSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
