...
{
    /// <summary>
    /// Four Totems - Four Totems
    /// Circle: 7 (28 mana)
    /// </summary>
    public class ShamanicFourTotemsSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Four Totems", "Fourum Totemsum",
            203,
            9041,
            false
        );
        ...
        public ShamanicFourTotemsSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Four Totems - Four Totems Circle: 7 (28 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicFourTotems_Totem", 10, TimeSpan.FromMinutes(duration)));
