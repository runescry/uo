...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class ShamanicLightningStormSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Lightning Storm", "Lightningum Stormum",
            203,
            9041,
            false
        );
        ...
        public ShamanicLightningStormSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ShamanicLightningStormSpell m_Owner;

            public InternalTarget(ShamanicLightningStormSpell owner)
