...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class ShamanicHealingStreamSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Healing Stream", "Healingum Streamum",
            203,
            9041,
            false
        );
        ...
        public ShamanicHealingStreamSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly ShamanicHealingStreamSpell m_Owner;

            public InternalTarget(ShamanicHealingStreamSpell owner)
