...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 7 (28 mana)
    /// </summary>
    public class ShamanicAscendanceSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Ascendance", "Ascendanceus",
            203,
            9041,
            false
        );
        ...
        public ShamanicAscendanceSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Ascendance - Ascendance Circle: 7 (28 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ShamanicAscendance_Int", -7, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ShamanicAscendance!");
        ...
        {
            private readonly ShamanicAscendanceSpell m_Owner;

            public InternalTarget(ShamanicAscendanceSpell owner)
