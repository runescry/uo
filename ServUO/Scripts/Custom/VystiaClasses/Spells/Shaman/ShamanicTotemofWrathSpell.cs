...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class ShamanicTotemofWrathSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Totem of Wrath", "Totemum Ofum Wrathum",
            203,
            9041,
            false
        );
        ...
        public ShamanicTotemofWrathSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Totem of Wrath - Totem of Wrath Circle: 6 (24 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicTotemofWrath_Totem", 10, TimeSpan.FromMinutes(duration)));
