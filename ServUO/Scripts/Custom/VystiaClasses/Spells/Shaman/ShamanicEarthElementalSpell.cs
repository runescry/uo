...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class ShamanicEarthElementalSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Earth Elemental", "Earthum Elementalum",
            203,
            9041,
            false
        );
        ...
        public ShamanicEarthElementalSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Earth Elemental - Earth Elemental Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "ShamanicEarthElemental_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by ShamanicEarthElemental!");
        ...
        {
            private readonly ShamanicEarthElementalSpell m_Owner;

            public InternalTarget(ShamanicEarthElementalSpell owner)
