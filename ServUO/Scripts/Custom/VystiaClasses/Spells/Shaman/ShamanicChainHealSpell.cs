...
namespace Server.Spells.VystiaSpells.Shamanic
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class ShamanicChainHealSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Chain Heal", "Chainum Sanitas",
            203,
            9041,
            false
        );
        ...
        public ShamanicChainHealSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                {
                    double healAmount = Utility.RandomMinMax(25, 40);
        ...
        {
            private readonly ShamanicChainHealSpell m_Owner;

            public InternalTarget(ShamanicChainHealSpell owner)
