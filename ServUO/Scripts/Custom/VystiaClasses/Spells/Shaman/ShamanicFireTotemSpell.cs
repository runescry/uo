...
{
    /// <summary>
    /// Fire Totem - Fire Totem
    /// Circle: 2 (8 mana)
    /// </summary>
    public class ShamanicFireTotemSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Fire Totem", "Ignis Totemum",
            203,
            9041,
            false
        );
        ...
        public ShamanicFireTotemSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Fire Totem - Fire Totem Circle: 2 (8 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicFireTotem_Totem", 10, TimeSpan.FromMinutes(duration)));
