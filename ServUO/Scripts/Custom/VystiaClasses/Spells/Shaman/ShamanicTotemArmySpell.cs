...
{
    /// <summary>
    /// Totem Army - Totem Army
    /// Circle: 8 (32 mana)
    /// </summary>
    public class ShamanicTotemArmySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Totem Army", "Totemum Armyum",
            203,
            9041,
            false
        );
        ...
        public ShamanicTotemArmySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                // Totem Army - Totem Army Circle: 8 (32 mana)
                ...
                foreach (Mobile m in eable)
                {
                    ...
                    {
                        m.AddStatMod(new StatMod(StatType.Str, "ShamanicTotemArmy_Totem", 10, TimeSpan.FromMinutes(duration)));
