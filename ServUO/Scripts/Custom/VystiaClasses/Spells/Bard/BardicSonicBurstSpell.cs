...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 2 (8 mana)
    /// </summary>
    public class BardicSonicBurstSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Sonic Burst", "Sonicum Burstum",
            203,
            9041,
            false
        );
        ...
        public BardicSonicBurstSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Sonic Burst - Sonic Burst Circle: 2 (8 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicSonicBurst_Int", -2, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicSonicBurst!");
        ...
        {
            private readonly BardicSonicBurstSpell m_Owner;

            public InternalTarget(BardicSonicBurstSpell owner)
