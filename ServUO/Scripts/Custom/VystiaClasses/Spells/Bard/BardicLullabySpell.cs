...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class BardicLullabySpell : VystiaSpell
    {
        ...
        public BardicLullabySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Lullaby - Lullaby Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicLullaby_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicLullaby!");
        ...
        {
            private readonly BardicLullabySpell m_Owner;

            public InternalTarget(BardicLullabySpell owner)
