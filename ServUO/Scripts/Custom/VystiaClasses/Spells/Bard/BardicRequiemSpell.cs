...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 5 (20 mana)
    /// </summary>
    public class BardicRequiemSpell : VystiaSpell
    {
        ...
        public BardicRequiemSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Requiem - Requiem Circle: 5 (20 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicRequiem_Int", -5, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicRequiem!");
        ...
        {
            private readonly BardicRequiemSpell m_Owner;

            public InternalTarget(BardicRequiemSpell owner)
