...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 1 (4 mana)
    /// </summary>
    public class BardicSongofCourageSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Song of Courage", "Songum Ofum Courageus",
            203,
            9041,
            false
        );
        ...
        public BardicSongofCourageSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Song of Courage - Song of Courage Circle: 1 (4 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicSongofCourage_Int", -1, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicSongofCourage!");
        ...
        {
            private readonly BardicSongofCourageSpell m_Owner;

            public InternalTarget(BardicSongofCourageSpell owner)
