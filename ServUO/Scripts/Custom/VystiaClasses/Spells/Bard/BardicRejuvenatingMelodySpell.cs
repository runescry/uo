...
{
    /// <summary>
    /// Rejuvenating Melody - Rejuvenating Melody
    /// Circle: 2 (8 mana)
    /// </summary>
    public class BardicRejuvenatingMelodySpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Rejuvenating Melody", "Rejuvenatingum Melodyum",
            203,
            9041,
            false
        );
        ...
        public BardicRejuvenatingMelodySpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        public void Target(IDamageable target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                {
                    double healAmount = Utility.RandomMinMax(3, 5);
        ...
        {
            private readonly BardicRejuvenatingMelodySpell m_Owner;

            public InternalTarget(BardicRejuvenatingMelodySpell owner)
