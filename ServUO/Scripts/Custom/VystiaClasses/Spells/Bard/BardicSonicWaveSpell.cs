...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 4 (16 mana)
    /// </summary>
    public class BardicSonicWaveSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Sonic Wave", "Sonicum Waveus",
            203,
            9041,
            false
        );
        ...
        public BardicSonicWaveSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
...
// Check fizzle and trigger skill gain
        ...
        {
            private readonly BardicSonicWaveSpell m_Owner;

            public InternalTarget(BardicSonicWaveSpell owner)
