...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 3 (12 mana)
    /// </summary>
    public class BardicWarSongSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "War Song", "Warum Songum",
            203,
            9041,
            false
        );
        ...
        public BardicWarSongSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // War Song - War Song Circle: 3 (12 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicWarSong_Int", -3, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicWarSong!");
        ...
        {
            private readonly BardicWarSongSpell m_Owner;

            public InternalTarget(BardicWarSongSpell owner)
