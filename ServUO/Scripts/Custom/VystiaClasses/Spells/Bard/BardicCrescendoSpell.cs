...
namespace Server.Spells.VystiaSpells.Bardic
{
    ...
    /// Circle: 6 (24 mana)
    /// </summary>
    public class BardicCrescendoSpell : VystiaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Crescendo", "Crescendoum",
            203,
            9041,
            false
        );
        ...
        public BardicCrescendoSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public void Target(Mobile target)
        {
            ...
            else if (CheckHSequence(target))
            {
                ...
                // Crescendo - Crescendo Circle: 6 (24 mana)
                target.AddStatMod(new StatMod(StatType.Int, "BardicCrescendo_Int", -6, TimeSpan.FromSeconds(duration)));

                target.SendMessage(0x22, "You feel weakened by BardicCrescendo!");
        ...
        {
            private readonly BardicCrescendoSpell m_Owner;

            public InternalTarget(BardicCrescendoSpell owner)
