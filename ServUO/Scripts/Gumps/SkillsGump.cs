...
namespace Server.Gumps
{
    ...
    public class SkillsGumpGroup
    {
        private static readonly SkillsGumpGroup[] m_Groups = new SkillsGumpGroup[]
        {
            ...
            new SkillsGumpGroup("Vystia Magic", new SkillName[]
            {
                SkillName.Cryomancy,
                SkillName.Demonology,
                SkillName.NecromancyArts,
                SkillName.Druidism,
                ...
                SkillName.SpiritCalling,
                SkillName.Runeweaving,
                SkillName.IllusionMagic
            }),
            new SkillsGumpGroup("Vystia Martial", new SkillName[]
            {
                SkillName.Berserking,
                SkillName.Subterfuge,
                SkillName.MartialArts,
                SkillName.ChivalricArts,
                SkillName.HolyDevotion,
                SkillName.Marksmanship,
                SkillName.CombatMastery,
                SkillName.Zealotry,
                SkillName.Manhunting,
                SkillName.BeastBonding,
                SkillName.Engineering,
                SkillName.Transmutation,
                SkillName.DivineGrace,
                SkillName.ArcaneStudies
            })
        };
