...
namespace Server.Commands
{
    ...
    public class DecorationList
    {
        ...
        public Item Construct()
        {
            ...
            // Spawner configuration from decoration files
            // These attributes represent the baseline for world creation/recreation/deletion scripts.
            ...
            else if (item is Server.Mobiles.Spawner)
            {
                ...
                // Parse decoration file parameters to configure spawner attributes
                // These parameters are documented in SpawnerBaseline.Defaults
                for (int i = 0; i < m_Params.Length; ++i)
                {
                    // Spawn parameter: Adds spawn objects to the spawner
                    // Format: Spawn=<creature name>
                    ...
                    // MinDelay parameter: Minimum time between spawns
                    // Format: MinDelay=<TimeSpan>
                    // Baseline default: TimeSpan.FromMinutes(5)
                    ...
                    // MaxDelay parameter: Maximum time between spawns
                    // Format: MaxDelay=<TimeSpan>
                    // Baseline default: TimeSpan.FromMinutes(10)
                    ...
                    // NextSpawn parameter: Time until next spawn
                    // Format: NextSpawn=<TimeSpan>
                    // Baseline default: TimeSpan.Zero
                    ...
                    // Count parameter: Maximum number of creatures to spawn
                    // Format: Count=<int>
                    ...
                    // Team parameter: Team number for spawned creatures
                    // Format: Team=<int>
                    // Baseline default: 0
                    ...
                    // HomeRange parameter: Home range for spawned creatures
                    // Format: HomeRange=<int>
                    // Baseline default: 5
                    ...
                    // Running parameter: Whether spawner is active
                    // Format: Running=<bool>
                    ...
                    // Group parameter: Group spawn mode (all at once vs individual)
                    // Format: Group=<bool>
