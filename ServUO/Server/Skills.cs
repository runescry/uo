...
namespace Server
{
	...
	public enum SkillName
	{
		...
		// Vystia Custom Class Skills (58-83)
		// Magic Class Skills
		Cryomancy = 58,        // Ice Mage - ice magic mastery
		Demonology = 59,       // Warlock - dark pact magic
		NecromancyArts = 60,   // Necromancer - undead control (different from base Necromancy)
		Druidism = 61,         // Druid - nature magic, shapeshifting
		Elementalism = 62,     // Sorcerer - elemental attunement
		Songweaving = 63,      // Bard - songweaving mastery
		BardicLore = Songweaving, // Legacy alias
		Hexcraft = 64,         // Witch - curse potency
		Divination = 65,       // Oracle - foresight, time manipulation
		Conjuration = 66,      // Summoner - summon power
		SpiritCalling = 67,    // Shaman - totem power
		Runeweaving = 68,      // Enchanter - enchantment power
		IllusionMagic = 69,    // Illusionist - illusion duration

		// Martial Class Skills
		Berserking = 70,       // Barbarian - fury generation
		Subterfuge = 71,       // Rogue - combo points, stealth
		MartialArts = 72,      // Monk - chi generation
		ChivalricArts = 73,    // Knight - fortitude, defense
		HolyDevotion = 74,     // Paladin - virtue power
		Marksmanship = 75,     // Ranger - focus, aspects
		CombatMastery = 76,    // Fighter - stance effectiveness
		Zealotry = 77,         // Templar - zeal generation
		Manhunting = 78,       // Bounty Hunter - pursuit, tracking
		BeastBonding = 79,     // Beastmaster - pet power
		Engineering = 80,      // Artificer - construct power
		Transmutation = 81,    // Alchemist - potion power
		DivineGrace = 82,      // Cleric - faith, healing
		ArcaneStudies = 83     // Wizard - spell mastery
	}
	...
	public class SkillInfo
	{
        ...
        private static SkillInfo[] m_Table = new SkillInfo[84]
		{
			...
			// Vystia Custom Class Skills (58-83)
			// Magic Class Skills
			new SkillInfo(58, "Cryomancy", 0.0, 0.0, 10.0, "Cryomancer", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(59, "Demonology", 0.0, 0.0, 10.0, "Demonologist", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(60, "Necromantic Arts", 0.0, 0.0, 10.0, "Death Master", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(61, "Druidism", 0.0, 0.0, 10.0, "Archdruid", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(62, "Elementalism", 0.0, 0.0, 10.0, "Elementalist", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(63, "Songweaving", 0.0, 5.0, 5.0, "Songweaver", null, 0.0, 0.5, 0.5, 1.0, StatCode.Int, StatCode.Dex, true),
			new SkillInfo(64, "Hexcraft", 0.0, 0.0, 10.0, "Hexer", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(65, "Divination", 0.0, 0.0, 10.0, "Seer", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(66, "Conjuration", 0.0, 0.0, 10.0, "Conjurer", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(67, "Spirit Calling", 0.0, 0.0, 10.0, "Spirit Walker", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(68, "Runeweaving", 0.0, 5.0, 5.0, "Runemaster", null, 0.0, 0.5, 0.5, 1.0, StatCode.Int, StatCode.Dex, true),
			new SkillInfo(69, "Illusion Magic", 0.0, 5.0, 5.0, "Phantasmist", null, 0.0, 0.5, 0.5, 1.0, StatCode.Int, StatCode.Dex, true),

			// Martial Class Skills
			new SkillInfo(70, "Berserking", 10.0, 0.0, 0.0, "Berserker", null, 1.0, 0.0, 0.0, 1.0, StatCode.Str, StatCode.Dex, true),
			new SkillInfo(71, "Subterfuge", 0.0, 10.0, 0.0, "Shadow", null, 0.0, 1.0, 0.0, 1.0, StatCode.Dex, StatCode.Int, true),
			new SkillInfo(72, "Martial Arts", 5.0, 5.0, 0.0, "Grandmaster", null, 0.5, 0.5, 0.0, 1.0, StatCode.Dex, StatCode.Str, true),
			new SkillInfo(73, "Chivalric Arts", 7.5, 2.5, 0.0, "Champion", null, 0.75, 0.25, 0.0, 1.0, StatCode.Str, StatCode.Dex, true),
			new SkillInfo(74, "Holy Devotion", 5.0, 0.0, 5.0, "Crusader", null, 0.5, 0.0, 0.5, 1.0, StatCode.Str, StatCode.Int, true),
			new SkillInfo(75, "Marksmanship", 0.0, 10.0, 0.0, "Sharpshooter", null, 0.0, 1.0, 0.0, 1.0, StatCode.Dex, StatCode.Str, true),
			new SkillInfo(76, "Combat Mastery", 7.5, 2.5, 0.0, "Warlord", null, 0.75, 0.25, 0.0, 1.0, StatCode.Str, StatCode.Dex, true),
			new SkillInfo(77, "Zealotry", 5.0, 0.0, 5.0, "Zealot", null, 0.5, 0.0, 0.5, 1.0, StatCode.Str, StatCode.Int, true),
			new SkillInfo(78, "Manhunting", 0.0, 7.5, 2.5, "Hunter", null, 0.0, 0.75, 0.25, 1.0, StatCode.Dex, StatCode.Int, true),
			new SkillInfo(79, "Beast Bonding", 5.0, 0.0, 5.0, "Beastlord", null, 0.5, 0.0, 0.5, 1.0, StatCode.Str, StatCode.Int, true),
			new SkillInfo(80, "Engineering", 0.0, 5.0, 5.0, "Chief Engineer", null, 0.0, 0.5, 0.5, 1.0, StatCode.Int, StatCode.Dex, true),
			new SkillInfo(81, "Transmutation", 0.0, 0.0, 10.0, "Transmuter", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Dex, true),
			new SkillInfo(82, "Divine Grace", 0.0, 0.0, 10.0, "High Priest", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
			new SkillInfo(83, "Arcane Studies", 0.0, 0.0, 10.0, "Archmage", null, 0.0, 0.0, 1.0, 1.0, StatCode.Int, StatCode.Str, true),
        };
	...
	public class Skills : IEnumerable<Skill>
	{
		...
		#region Vystia Custom Class Skills
		// Magic Class Skills
		[CommandProperty(AccessLevel.Counselor)]
		public Skill Cryomancy { get { return this[SkillName.Cryomancy]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Demonology { get { return this[SkillName.Demonology]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill NecromancyArts { get { return this[SkillName.NecromancyArts]; } set { } }
		...
		[CommandProperty(AccessLevel.Counselor)]
		public Skill Songweaving { get { return this[SkillName.Songweaving]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill BardicLore { get { return this[SkillName.BardicLore]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Hexcraft { get { return this[SkillName.Hexcraft]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Divination { get { return this[SkillName.Divination]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Conjuration { get { return this[SkillName.Conjuration]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill SpiritCalling { get { return this[SkillName.SpiritCalling]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Runeweaving { get { return this[SkillName.Runeweaving]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill IllusionMagic { get { return this[SkillName.IllusionMagic]; } set { } }

		// Martial Class Skills
		[CommandProperty(AccessLevel.Counselor)]
		public Skill Berserking { get { return this[SkillName.Berserking]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Subterfuge { get { return this[SkillName.Subterfuge]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill MartialArts { get { return this[SkillName.MartialArts]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill ChivalricArts { get { return this[SkillName.ChivalricArts]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill HolyDevotion { get { return this[SkillName.HolyDevotion]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Marksmanship { get { return this[SkillName.Marksmanship]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill CombatMastery { get { return this[SkillName.CombatMastery]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Zealotry { get { return this[SkillName.Zealotry]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Manhunting { get { return this[SkillName.Manhunting]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill BeastBonding { get { return this[SkillName.BeastBonding]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Engineering { get { return this[SkillName.Engineering]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill Transmutation { get { return this[SkillName.Transmutation]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill DivineGrace { get { return this[SkillName.DivineGrace]; } set { } }

		[CommandProperty(AccessLevel.Counselor)]
		public Skill ArcaneStudies { get { return this[SkillName.ArcaneStudies]; } set { } }
		#endregion
